...
if (workbox) {
    ...
    const baseUrl = 'https://personeriadeibague.gov.co'
    //const baseUrl = 'https://staging.fhaproducts.com'
    //const baseUrl = 'https://appapi.fhaproducts.com'

    // Set a name for the current cache
    var shellCacheName = 'personeria_app';
    var filesToCache = []
